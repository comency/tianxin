...
(
    ...
    "shop_name"               varchar  NOT NULL DEFAULT '',
...
(
    ...
    "order_pay_amount"           int      NOT NULL,
    "refund_amount"              int      NOT NULL,
    "settlement_base_amount"     int      NOT NULL,
...
(
    ...
    "order_id"                   bigint   NOT NULL,
    "order_no"                   varchar  NOT NULL,
    "order_finish_time"          datetime NOT NULL,
    ...
    "tenant_id"                  bigint   NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
    UNIQUE ("tenant_id", "order_id", "active")
) COMMENT '店铺结算订单明细';
