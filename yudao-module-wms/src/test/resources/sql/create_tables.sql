...
CREATE TABLE IF NOT EXISTS "wms_inventory_reservation" (
    ...
    "deleted" bit NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_mall_order_sku_warehouse" UNIQUE ("order_no", "sku_id", "warehouse_id", "deleted")
) COMMENT '商城订单 WMS 库存预占表';
...
CREATE TABLE IF NOT EXISTS "wms_inventory_return" (
    ...
    "deleted" bit NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_mall_return_sku_warehouse" UNIQUE ("return_no", "sku_id", "warehouse_id", "deleted")
) COMMENT '商城售后退货 WMS 入库记录';
