<!-- 商品分类列表 -->
<template>
  <s-layout :bgStyle="{ color: '#f4f7f8' }" tabbar="/pages/index/category" title="分类">
        ...
        .menu-item {
          ...
          .menu-title {
            ...
            &::before {
              ...
              width: 64rpx;
              height: 12rpx;
              background: linear-gradient(90deg, #2b8389, #9fd4ce) !important;
              position: absolute;
              left: -64rpx;
              bottom: 0;
              z-index: -1;
          ...
          &.menu-item-active {
            ...
            box-shadow: 0 5rpx 15rpx rgba(32, 74, 85, .06);
