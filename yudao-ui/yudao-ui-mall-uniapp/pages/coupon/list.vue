<!-- 优惠券中心  -->
<template>
  <s-layout :bgStyle="{ color: '#f4f7f8' }" title="优惠券">
    <su-sticky bgColor="#f4f7f8">
      <su-tabs
        :list="tabMaps"
        :scrollable="false"
        @change="onTabsChange"
...
<style lang="scss" scoped>
  .card-btn {
    ...
    height: 50rpx;
    border-radius: 40rpx;
    background: linear-gradient(90deg, #1d6570, #2f9294);
    box-shadow: 0 5rpx 12rpx rgba(31, 112, 119, .18);
    color: #ffffff;
    font-size: 24rpx;
    font-weight: 400;
  }
  ...
  .border-btn {
    background: linear-gradient(90deg, #8cc1bd, #b8ddd4);
    color: #fff !important;
  }
